...
# from . import bitmap_to_surface
from PIL import Image


def get_ctx(ctx_in, txt):
    ctx = ctx_in
    ...
    font_dir = '/Users/ewanog/Documents/work/code/repos/harfbuzz-python-demos/Arial.ttf'

    fontdata = open (font_dir, 'rb').read ()
    text = tounicode(txt)
    ...
    for info,pos,extent in zip(infos, positions, glyph_extents):
        ...
        #     glyph_surface = bitmap_to_surface.make_image_surface(face.glyph.bitmap)
